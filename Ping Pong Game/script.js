...
//and we will update the position of ball by adding the velocity to the position of the ball
//and we will check if the ball is hitting the wall or the paddle,
//if it is hitting the paddle , we will change the direction of the ball and icrease the speed of the ball
...
let ballcenterY = paddle.offsetTop + ball.offsetHeight / 2;
